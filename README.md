...
本项目为本学院计算机网络与通信课程的第一次实验作业。虽然代码主要由llms编写，但也不能说作者完全不懂HTML,毕竟从大一开始也做过好几个网页了（老师别挂我ww）。如果喜欢本项目的logo，也请自取哈。

如果大家想要快速访问，可以保存 https://93972698.github.io/SCU-HUB/ 到本地终端随时访问。

现在对于本项目进行简单说明。

## 网站首页快照
<img width="1549" height="1248" alt="image" src="https://github.com/user-attachments/assets/2387c07c-8a8d-41ab-ae7b-c96cea66ab45" />
